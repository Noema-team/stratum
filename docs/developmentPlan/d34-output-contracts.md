...
| 2026-09-11 | *(this commit)* | C2 readiness codec (`src/workflow/methodology/readiness-contract.ts`) — IN REVIEW; contract deliberately NOT registered in production (C3 scope) |
