...
export type CycleOutcome = 'completed' | 'halted' | 'running'
export type PlanningDepth = 'minimal' | 'standard' | 'deep' | 'research'
export type ArtifactScope = 'project' | 'group'
export type AgentRole = 'explorer' | 'designer' | 'planner' | 'tester' | 'builder' | 'debugger' | 'evaluator' | 'critic' | 'historian' | 'facilitator'
export type GroupStatus = 'active' | 'complete' | 'blocked'
...
export interface RuntimeMap {
  ...
  context: {
    ...
    agent_slices: Record<AgentRole, string[]>
  }
